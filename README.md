...
2. **Cancelar** (GPIO 23): única forma de limpar buffer/senha em andamento.
3. **Confirmar** (GPIO 18): com 4 dígitos, valida e registra; com buffer incompleto, **não apaga** — só avisa.
